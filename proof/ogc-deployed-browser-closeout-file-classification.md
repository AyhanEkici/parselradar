# OGC Deployed Browser Closeout - File Classification

## REQUIRED_OGC_CONTRACT_FIX
- apps/api/src/connectors/ogc/ogcTypes.ts
- apps/api/src/connectors/ogc/ogcCapabilitiesClient.ts

## REQUIRED_OGC_UI_FIX
- apps/web/src/components/connectors/OgcServiceDiagnosticsCard.tsx

## REQUIRED_OGC_PROOF
- apps/api/scripts/verifyConnectorDiagnosticsContract.ts
- package.json
- proof/connector-diagnostics-contract.json
- proof/connector-diagnostics-contract.md
- proof/ogc-diagnostics-ui-contract.json
- proof/ogc-diagnostics-ui-contract.md
- proof/ogc-live-diagnostics-payload.json
- proof/ogc-live-diagnostics-payload.md
- proof/ogc-deployed-browser-closeout-local-results.json
- proof/ogc-deployed-browser-closeout-local-results.md
- proof/ogc-deployed-browser-closeout-file-classification.json
- proof/ogc-deployed-browser-closeout-file-classification.md

## BASELINE_PROOF_OUTPUT
...
Commit policy:
- Allowed: REQUIRED_OGC_CONTRACT_FIX, REQUIRED_OGC_UI_FIX, REQUIRED_OGC_PROOF
- Disallowed: BASELINE_PROOF_OUTPUT, PREVIOUS_SESSION_NOISE, UNKNOWN_REQUIRES_REVIEW
