...
Generated at: 2026-05-21T20:33:45.117Z
Overall status: WARN
Git SHA: 38355679a8c5cda4122991a60ae8d8de2be0273d
...
| PASS | JWT_SECRET readiness | JWT secret is present with acceptable length. | JWT_SECRET=[REDACTED], length=96 |
...
| PASS | Core runtime env readiness | Core runtime env keys are present. | MONGODB_URI=PRESENT, JWT_SECRET=[REDACTED], CLIENT_URL=PRESENT |
