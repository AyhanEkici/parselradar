            ...
            {showAuthenticatedNav ? (
              <>
                <nav className="flex flex-wrap gap-2 text-xs">
                  ...
                  {isAdmin ? <Link to="/admin/runtime-health" className="hover:underline">Runtime Health</Link> : null}
                  ...
                  {isAdmin ? <Link to="/admin/mail-diagnostics" className="hover:underline">Mail</Link> : null}
                  ...
                  {isAdmin ? <Link to="/admin/cms" className="hover:underline">CMS</Link> : null}
                  ...
                  {isAdmin ? <Link to="/admin/geo-diagnostics" className="hover:underline">Geo Diagnostics</Link> : null}
                  <Link to="/map" className="hover:underline">Map (Preview)</Link>
                  <Link to="/map/portfolio" className="hover:underline">Map Portfolio (Preview)</Link>
