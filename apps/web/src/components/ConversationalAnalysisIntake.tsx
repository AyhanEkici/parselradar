  ...
  return (
    <section className="rounded-xl border border-slate-200 bg-white p-4 shadow-sm">
      ...
      <div className="mt-4 grid grid-cols-1 gap-3 sm:grid-cols-2">
        <input className="rounded border border-slate-300 p-2 text-sm" P2_1A_TRIAGED_BACKLOG="İl" value={contract.il} onChange={(event) => setField('il', event.target.value)} />
        <input className="rounded border border-slate-300 p-2 text-sm" P2_1A_TRIAGED_BACKLOG="İlçe" value={contract.ilce} onChange={(event) => setField('ilce', event.target.value)} />
        ...
        <input className="rounded border border-slate-300 p-2 text-sm" P2_1A_TRIAGED_BACKLOG="m²" value={contract.areaM2} onChange={(event) => setField('areaM2', event.target.value)} />
        <input className="rounded border border-slate-300 p-2 text-sm" P2_1A_TRIAGED_BACKLOG="Fiyat/m²" value={contract.pricePerM2} onChange={(event) => setField('pricePerM2', event.target.value)} />
        ...
        <input className="rounded border border-slate-300 p-2 text-sm sm:col-span-2" P2_1A_TRIAGED_BACKLOG="İlan URL" value={contract.listingUrl} onChange={(event) => setField('listingUrl', event.target.value)} />
      </div>

      <div className="mt-3 rounded border border-slate-200 bg-slate-50 p-3 text-sm text-slate-700">
        <p>Ada/parsel bilgisi olmadan rapor daha sınırlı olur.</p>
        <p className="mt-1">Fiyat/m² bilgisi fırsat/risk yorumunu daha anlamlı hale getirir.</p>
      ...
      <div className="mt-3 space-y-2 rounded border border-blue-200 bg-blue-50 p-3 text-sm text-blue-900">
        ...
        <p>Upload/OCR preview henüz aktif değil.</p>
      </div>
