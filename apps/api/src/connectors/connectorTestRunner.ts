import { ConnectorDefinition, ConnectorState, ConnectorTestResult } from './connectorContracts';
import { connectorStatus } from './connectorStatus';
import { CONNECTOR_ACTIVATION_POLICIES } from '../config/connectors/connectorActivationPolicies';

export async function connectorTestRunner(connector: ConnectorDefinition): Promise<ConnectorTestResult> {
  ...
  const testState: ConnectorState = explicitPassFlag ? 'TEST_PASSED' : 'TEST_FAILED';
