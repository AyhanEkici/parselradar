...
exports.listingConnector = listingConnector;
...
function listingConnector(input) {
    ...
    if (!endpoint) {
        ...
        if (ageMinutes > connectorSchedules_1.CONNECTOR_SCHEDULES.listing.staleAfterMinutes) {
            status = 'STALE';
