...
| PR-PROD-005 | 2026-05-25 | external.viewer.real | EXTERNAL_VIEWER | Conversational workflow | P1_FLOW_BLOCKER | https://parselradar.vercel.app/properties/new | User should be able to reach analysis intent through a guided conversation-first flow | Real viewer expects Google-search/chat-like interaction and does not find tab-heavy flow aligned to expectation | OPEN_NEXT_SPRINT | Product+Web UX | P2.CONTROLLED-BETA-FEEDBACK-INGESTION-REAL-1 | REAL_FEEDBACK_CAPTURED_HIGH_SIGNAL. Prioritize conversation-first workflow spec/build before stronger demo. |
| PR-PROD-006 | 2026-05-25 | external.viewer.real | EXTERNAL_VIEWER | Navigation clarity | P2_PRODUCT_ISSUE | https://parselradar.vercel.app/properties/new | User should clearly understand whether tabs are required and what Yeni Mulk fills automatically | Viewer is unclear whether many nav tabs are necessary and whether Yeni Mulk auto-fills downstream tabs | OPEN_NEXT_SPRINT | Product+Web UX | P2.CONTROLLED-BETA-FEEDBACK-INGESTION-REAL-1 | Clarify tab purpose and data propagation rules in UI copy and guided flow. |
